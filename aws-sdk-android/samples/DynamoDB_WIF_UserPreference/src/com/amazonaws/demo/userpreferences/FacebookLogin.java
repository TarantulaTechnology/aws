...
import com.amazonaws.demo.userpreferences.AlertActivity;
import com.amazonaws.demo.userpreferences.UserPreferenceDemoActivity;
import com.amazonaws.demo.userpreferences.WIFIdentityProvider;
    ...
    private class SessionStatusCallback implements Session.StatusCallback {
        ...
        public void call(Session session, SessionState state, Exception exception) {
            ...
            if (session.isOpened()) {
                ...
                try {
                    UserPreferenceDemoActivity.clientManager.login(new FacebookIDP());
